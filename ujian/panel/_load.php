				...
				echo "
						<div class='direct-chat-msg' >
							...
							<div class='direct-chat-text'>
								<span class='$color'><i class='fas $icon'></i> " . ucfirst($log['text']) . "</span>
							</div><!-- /.direct-chat-text -->
						</div><!-- /.direct-chat-msg -->
					";
			} else {
				($log['type'] == 'testongoing') ? $icon = 'fa-edit' : $icon = 'fa-check-square-o';
				echo "
						<div class='direct-chat-msg right'>
							...
							<span class='direct-chat-img'><img src='../dist/img/avatar5.png' width=45></span><!-- /.direct-chat-img -->
							<div class='direct-chat-text'>
								<span><i class='fas $icon'></i> " . ucfirst($log['text']) . "...</span>
							</div><!-- /.direct-chat-text -->
						</div><!-- /.direct-chat-msg -->
					";
			}
