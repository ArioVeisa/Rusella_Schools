...
<head>
    ...
    <title>Tambah Data Materi - Rusella </title>
    <!-- General CSS Files -->
...
<body>
    ...
    <div id="app">
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text"> Tambahkan materi yang sesuai diampu
                                </p>
                                        ...
                                        <form method="post" enctype="multipart/form-data" action="<?= base_url('guru/add_materi') ?>">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <small>List guru sudah tersedia, kalian hanya
        ...
        <?php if ($this->session->flashdata('fail-upload')) : ?>
            <script>
                Swal.fire({
                    icon: 'error',
                    title: 'Upload Gagal!',
                    text: '<?= $this->session->flashdata('fail-upload') ?>',
                    showConfirmButton: true
                })
            </script>
            <?php $this->session->unset_userdata('fail-upload'); ?>
        <?php endif; ?>
        <!-- End Flash Messages -->
