...
<head>
    ...
    <title>Data Siswa - Rusella</title>
    <!-- General CSS Files -->
...
<body>
        ...
        <div class="main-wrapper">
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Siswa Rusella</h2>
                            <hr>
                            <p class="card-text"> Management Data Siswa.</p>
    ...
    <?php if ($this->session->flashdata('success-edit')) : ?>
        ...
        <?php $this->session->unset_userdata('success-edit'); ?>
    <?php endif; ?>
    ...
    <?php if ($this->session->flashdata('user-delete')) : ?>
        ...
        <?php $this->session->unset_userdata('user-delete'); ?>
    <?php endif; ?>
