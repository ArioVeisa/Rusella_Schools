...
<head>
	...
	<title>Tentang Developer - Rusella</title>
	<!-- General CSS Files -->
		...
		<div class="main-wrapper">
				...
				<ul class="navbar-nav navbar-right">
					<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
							...
							<div class="d-sm-none d-lg-inline-block" style="font-size:15px;">Hello, <?php
																									echo isset($admin['username']) ? $admin['username'] : 'Admin';
																									?></div>
						</a>
						<div class="dropdown-menu dropdown-menu-right">
							<div class="dropdown-title">Admin - Rusella</div>
			...
			<div class="main-content">
				<section class="section">
					<div class="section-header">
						<h1 style="font-size: 27px; letter-spacing:-0.5px; color:black;">Tentang Project Rusella</h1>
					</div>
					<div class="">
					...
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Tentang Rusella</h2>
								<hr>
								<p class="card-text">Web Edukasi Open Source yang dibuat oleh Rusdiyanto Giri Agni. <br> Rusella adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. <br> Rusella dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja. </p>
							</div>
						</div>
					</div>
				</section>
			...
			<footer class="main-footer">
				<div class="text-center">
					Copyright &copy; 2025 <div class="bullet"></div><a href="https://www.facebook.com/rusdian.giri">Rusdiyanto Giri Agni</a>
				</div>
			</footer>
			<!-- End Footer -->
