				...
				<section class="section">
					...
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Rusdiyanto Giri Agni</h2>
								<hr>
								<p class="card-text">Software developer yang berkomitmen mengembangkan pendidikan di Indonesia melalui teknologi digital, solusi untuk pemerataan akses pendidikan di seluruh negeri. </p>
							</div>
						</div>
					</div>
					<br>
