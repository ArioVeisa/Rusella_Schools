...
<head>
    ...
    <title>Update Data Guru - Rusella</title>
    <!-- General CSS Files -->
...
<body>
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text">Silakan update data materi sesuai dengan informasi yang benar.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Flash Messages -->
    <?php if ($this->session->flashdata('fail-edit')) : ?>
        <script>
            Swal.fire({
                icon: 'error',
                title: 'Update Gagal!',
                text: '<?= $this->session->flashdata('fail-edit') ?>',
                showConfirmButton: true
            })
        </script>
        <?php $this->session->unset_userdata('fail-edit'); ?>
    <?php endif; ?>
    <!-- End Flash Messages -->
