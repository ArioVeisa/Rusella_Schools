...
<head>
    ...
    <title>Admin Dashboard - Rusella</title>
    <!-- General CSS Files -->
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text">Tambahkan materi pembelajaran baru untuk siswa dengan mudah melalui sistem Rusella.</p>
                        ...
                        <div class="hero text-white hero-bg-image" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg">
                            <div class=" hero-inner">
                                <h1>Selamat Datang, <?php
                                                    echo isset($admin['username']) ? $admin['username'] : 'Admin';
                                                    ?>!</h1>
                                <p class="lead">Selamat datang di dashboard admin sistem pembelajaran Rusella. Kelola data siswa, guru, dan materi dengan mudah.</p>
                                <div class="mt-4">
