...
<head>
    <meta charset="utf-8" />
    <title>Rusella - Update Materi</title>
...
<body
    ...
    <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
        <div class="kt-header-mobile__logo">
            <a href="<?=base_url('guru/update_materi')?>">
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-widget19__wrapper">
                                            ...
                                            <div class="kt-widget19__text">
                                                Silakan update data materi sesuai dengan informasi yang benar. Anda dapat mengubah deskripsi, kelas, dan video materi.
                                            </div>
                                        </div>
                                        <div class="kt-widget19__action">
                                            <a href="<?=base_url('guru/lihat_data')?>" class="btn btn-sm btn-label-brand btn-bold">Kembali ke Lihat Data</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="kt-portlet kt-portlet--mobile">
                                        ...
                                        <div class="kt-portlet__body">
                                            <form action="<?= base_url('guru/materi_update') ?>" method="post" enctype="multipart/form-data">
                                                <input type="hidden" name="id" value="<?= $materi['id'] ?>">
                                                <input type="hidden" name="video_old" value="<?= $materi['video'] ?>">
                                                
                                                <div class="form-group">
                                                    <label for="nama_guru">Nama Guru</label>
                                                    <input type="text" class="form-control" id="nama_guru" name="nama_guru" 
                                                           value="<?= $materi['nama_guru'] ?>" readonly>
                                                </div>

                                                <div class="form-group">
                                                    <label for="nama_mapel">Mata Pelajaran</label>
                                                    <input type="text" class="form-control" id="nama_mapel" name="nama_mapel" 
                                                           value="<?= $materi['nama_mapel'] ?>" readonly>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="kelas" name="kelas" required>
                                                        ...
                                                        <option value="X" <?= $materi['kelas'] == 'X' ? 'selected' : '' ?>>X</option>
                                                        <option value="XI" <?= $materi['kelas'] == 'XI' ? 'selected' : '' ?>>XI</option>
                                                        <option value="XII" <?= $materi['kelas'] == 'XII' ? 'selected' : '' ?>>XII</option>
                                                    </select>
                                                </div>

                                                <div class="form-group">
                                                    <label for="video">Video Materi (Opsional)</label>
                                                    <?php if (!empty($materi['video'])) : ?>
                                                        <div class="alert alert-info">
                                                            <i class="la la-video"></i> Video saat ini: <strong><?= $materi['video'] ?></strong>
                                                        </div>
                                                    <?php endif; ?>
                                                    <input type="file" class="form-control" id="video" name="video" accept="video/mp4,video/mkv,video/mov">
                                                    <small class="form-text text-muted">Format yang didukung: MP4, MKV, MOV. Maksimal 50MB.</small>
                                                </div>

                                                <div class="form-group">
                                                    <label for="deskripsi">Deskripsi Materi</label>
                                                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="5" required><?= $materi['deskripsi'] ?></textarea>
                                                    <?= form_error('deskripsi', '<small class="text-danger">', '</small>') ?>
                                                </div>

                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-primary">
                                                        <i class="la la-save"></i> Update Materi
                                                    </button>
                                                    <a href="<?= base_url('guru/lihat_data') ?>" class="btn btn-secondary">
                                                        <i class="la la-arrow-left"></i> Batal
                                                    </a>
                                                </div>
                                            </form>
                                        </div>
