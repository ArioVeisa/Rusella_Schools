...
<head>
    <meta charset="utf-8" />
    <title>Rusella - Tambah Materi</title>
...
echo isset($guru['nama_guru']) ? $guru['nama_guru'] : 'Guru';?>" class="form-control" id="inputEmail4">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
...
echo isset($guru['nama_mapel']) ? $guru['nama_mapel'] : 'Mata Pelajaran';?>" class="form-control" id="inputEmail4">
                                        </div>
                                    </div>
