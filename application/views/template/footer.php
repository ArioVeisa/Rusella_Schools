    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="https://www.smkpalapapare.sch.id/">Website Resmi Sekolah</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li>Software developer yang berkomitmen mengembangkan pendidikan di Indonesia melalui teknologi digital, solusi untuk pemerataan akses pendidikan di seluruh negeri.</li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang Rusella</h4>
                <p>
                    Web Edukasi Open Source yang dibuat oleh Rusdiyanto Giri Agni. Rusella adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. Rusella dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                <a href="https://colorlib.com" target="_blank">Rusella</a> <br> Rusella is made with <span class="text-danger"> &#10084;</span> by <a href="https://github.com/syauqi">Rusdiyanto Giri Agni </a> with MIT License
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            <div class="col-lg-4 col-md-4 footer-social">
                <a href="https://www.facebook.com/rusdian.giri"><i class="fa fa-facebook"></i></a>
                <a href="https://x.com/rusdi_giri"><i class="fa fa-twitter"></i></a>
                <a href="https://www.instagram.com/rose_fish_farm"><i class="fa fa-instagram"></i></a>
            </div>
        </div>
    </div>
</footer>
