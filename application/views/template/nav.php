...
<head>
    ...
    <meta content="Rusella dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja." name="Description" />
    <meta content="Rusella, E-learning, Rusdiyanto Giri Agni, programmer indonesia" name="keywords" />
    <link rel="icon" href="<?= base_url('assets/') ?>img/favicon.png" type="image/png">
    <title>Rusella - Belajar Dimana Saja & Kapan Saja !</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="container">
                <div class="float-left">
                    <ul class="list header_social">
                        <li><a href="https://www.facebook.com/rusdian.giri"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="https://x.com/rusdi_giri"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="https://www.instagram.com/rose_fish_farm"><i class="fa fa-instagram"></i></a></li>
                    </ul>
                </div>
                <div class="float-right">
                    <a class="dn_btn" href="mailto:admin@rusella.com">admin@rusella.com</a>
                </div>
            </div>
        </div>
