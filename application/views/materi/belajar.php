...
<head>
    ...
    <title>Selamat Belajar - <?php
                                echo isset($user['nama']) ? $user['nama'] : 'Siswa';
                                ?></title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mx-auto mt-4">
                <?php if (!empty($detail->video) && file_exists(FCPATH . 'assets/materi_video/' . $detail->video)): ?>
                    <video class="afterglow" controls id="myvideo" width="1280" height="720">
                ...
                <?php else: ?>
                    <div class="alert alert-info text-center" style="padding: 50px;">
                        <i class="fas fa-video-slash fa-3x mb-3" style="color: #6c757d;"></i>
                        <h4>Video Tidak Tersedia</h4>
                        <p>Video pembelajaran untuk materi ini belum tersedia atau sedang dalam proses pembuatan.</p>
                        <p>Silakan baca deskripsi materi di bawah untuk memahami pembelajaran.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
